...
public class HeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public HeaderDecoration(View view, boolean scrollsHorizontally, float parallax, float shadowSize, int columns, String text) {
        mView = view;
        mText = text;
            ...
            if (mHorizontal) {
                ...
                if (mView.getMeasuredHeight() <= 0) {
                    try{
                        ...
                        Log.e("exception","Header Decoration str121");
                    }
                }
                outRect.set(0, mView.getMeasuredHeight(), 0, 0); // размеры для небольшого вью
            }
        } else {
            outRect.setEmpty();
        }
    ...
    public static class Builder {
        ...
        public Builder inflate(@LayoutRes int layoutRes, int ver) {
            mView = LayoutInflater.from(mContext).inflate(layoutRes, null, false);
            TextView tv = mView.findViewById(R.id.textView98);
            tv.setText(mText);
            if(ver==1){
                tv.setEnabled(false);
            }else{
        ...
        public HeaderDecoration build() {
            ...
            return new HeaderDecoration(mView, mHorizontal, mParallax, mShadowSize * 1.5f, mColumns, mText);
        }
